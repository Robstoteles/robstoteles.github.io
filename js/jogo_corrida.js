...
$(function() {
    ...
    $('#go').click(function() {
        ...
        $('#car1').animate({
            ...
            $('#raceInfo1 span').text( 'Terminou em ' + place + ' Lugar  com o tempo de ' + raceTime1 + ' millisegundos!' );
        ...
        $('#car2').animate({
            ...
            // give some text feedback in the race info box
            $('#raceInfo2 span').text( 'Terminou em ' + place + ' Lugar  com o tempo de ' + raceTime2 + ' millisegundos!' );
